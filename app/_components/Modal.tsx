...
const Modal = ({ children }: ModalProps) => {
  ...
  // 이 모달은 /project/[id] 인터셉트 경로에서만 떠 있어야 한다
  const isModalRoute = pathname.startsWith("/project/");
            ...
            <RemoveScroll>
              ...
              >
                <div
                  ...
                  ref={contentRef}
                  className="
                    w-[92vw] md:w-[860px] max-w-[95vw] max-h-[calc(100vh_-_6rem)] my-12 p-6 md:p-8
